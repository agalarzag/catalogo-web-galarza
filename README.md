...
*   **Decisión:** Se implementó Context API puro para manejar el estado del carrito de forma global sin añadir dependencias externas, manteniendo el bundle ligero.
*   **Dificultad:** La sincronización compleja de múltiples filtros cruzados (búsqueda con normalización de tildes, categorías, marcas, precio, stock) sin saturar el componente visual.
*   **Solución:** Se extrajo toda la lógica de filtrado a un Custom Hook (`useCatalogFilters.ts`) para cumplir con la regla de 200 líneas por componente. Además, se implementó *Deep Linking* sincronizando el estado con la URL (`useSearchParams`).

## 📱 Capturas de Interfaz
**Vista Escritorio:**
![Vista Escritorio](public/escritorio.png)

**Vista Móvil:**
![Vista Móvil](public/movil.png)

## 📊 Rendimiento y Accesibilidad (Lighthouse)
![Reporte Lighthouse final](public/lighthouse.png)# Chamo Import - Catálogo Web Frontend
...
## 📊 Rendimiento y Accesibilidad (Lighthouse)
![Reporte Lighthouse final](public/lighthouse.png)