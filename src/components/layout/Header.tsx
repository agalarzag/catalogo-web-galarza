    ...
    <header className="w-full font-sans sticky top-0 z-50 bg-white shadow-md">
      ...
      <div className="hidden md:flex bg-gray-100 text-text-muted py-1.5 px-4 md:px-8 text-xs justify-between items-center border-b border-border">
        ...
        <div className="flex gap-4 items-center">
          ...
          <a href="#" aria-label="Síguenos en Facebook" className="hover:text-primary transition-colors text-text-muted">
            <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
          </a>
          <a href="#" aria-label="Síguenos en Instagram" className="hover:text-primary transition-colors text-text-muted">
      ...
      <div className="bg-white py-5 px-4 md:px-8 flex items-center justify-between gap-4 lg:gap-8">
        ...
        >
          ...
          />
          <button type="submit" aria-label="Buscar" className="absolute right-1.5 top-1/2 -translate-y-1/2 bg-primary hover:bg-primary-dark text-white w-10 h-10 rounded-full transition-colors flex items-center justify-center">
            <Search size={18} />
          </button>
        ...
        <div className="hidden lg:flex items-center gap-4">
          ...
          <button onClick={openCart} aria-label="Abrir carrito" className="group relative flex items-center gap-3 bg-secondary hover:bg-secondary/90 text-white px-5 py-2.5 rounded-full transition-all shadow-sm hover:shadow-md">
        ...
        <div className="flex lg:hidden items-center gap-3">
          <button onClick={openCart} aria-label="Abrir carrito" className="relative text-secondary p-2 bg-gray-100 rounded-full">
